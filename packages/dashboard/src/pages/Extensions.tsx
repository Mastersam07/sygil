...
export default function Extensions() {
  ...
  if (total === 0) return <EmptyState title="No extensions" message="Commands, skills, plugins, and MCP servers will appear here." icon={<Puzzle size={24} />} />;
